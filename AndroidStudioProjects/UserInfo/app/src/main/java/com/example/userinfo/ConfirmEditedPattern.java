...
public class ConfirmEditedPattern extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(str.equals(ptn)){
                    acc.setPassword(ptn);
                    flag = true;
                    Toast.makeText(ConfirmEditedPattern.this, "Password Edit Confirmed", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(ConfirmEditedPattern.this,"Password do not match...try again",Toast.LENGTH_SHORT).show();
                }
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ConfirmEditedPattern.this, EditPattern.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new ConnectIt().execute("1", acc.getPassword(),acc.getUserName(),acc.getEmail());
        ...
        protected Void doInBackground(String... params) {
            ...
            if (code == "1") {
                try {
                    ...
                    params[2] = acc.getUserName();
                    params[3] = acc.getEmail();

                    URI uri = null;
                    HttpPost post = new HttpPost();

                    uri = new URI("http://10.0.2.2/mobile/updatePattern.php");
                    List<NameValuePair> urlParameters = new ArrayList<>();
                    urlParameters.add(new BasicNameValuePair("password", params[1]));
                    urlParameters.add(new BasicNameValuePair("userName", params[2]));
                        ...
                        try {
                            if (Integer.parseInt(msg) > 0) {
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ConfirmEditedPattern.this, "Pattern Successfully Edited", Toast.LENGTH_SHORT).show();
                                        Intent intent = new Intent(ConfirmEditedPattern.this, MainPage.class);
                                        Bundle bundle = new Bundle();
                                        bundle.putSerializable("Account", acc);
                                        intent.putExtras(bundle);
                                        startActivity(intent);
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ConfirmEditedPattern.this, msg, Toast.LENGTH_SHORT).show();
                                    }
                                });
                            }
                        } catch (Exception e) {
