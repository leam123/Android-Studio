    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ptn = new String(x);
                flag = true;
                Toast.makeText(SetLock.this, "Password Set", Toast.LENGTH_SHORT).show();
            }
        });
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SetLock.this, Registration.class);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag){
                    Intent intent = new Intent(SetLock.this, ConfirmLock.class);
                    Bundle bundle = new Bundle();
                    bundle.putSerializable("Account", acc);
                    ...
                    Toast.makeText(SetLock.this,"Please set a pattern",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
